Scratchpad mini-projects by order of creation
---------------------------------------------

Short summaries of the different experiments leading up
to creating the main project.
...
### hello_world.py
Obligatory hello world in QT

### my_widget1.py
Continuation of the hello world
...
Experiments with function and design
====================================
...
### sqlalchemy_triple_view.py and sa_models1.py

### music_player_basic.py

### ffprobe_analyzer.py

### bridge_mediaplaylist_to_domain_model_experiment.py
